...
import { PredictionRunParams, PredictionRunResponse, PredictionStatusResponse,
  PredictionSubscribeParams,
  PredictionSubscribeResponse, Predictions } from './resources/predictions';
...
export class Fashn {
  ...
  constructor({
    ...
    this.logLevel = parseLogLevel(options.logLevel, 'ClientOptions.logLevel', this) ?? parseLogLevel(readEnv('FASHN_LOG'), 'process.env[\'FASHN_LOG\']', this) ?? defaultLogLevel;
