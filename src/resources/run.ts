...
export class Run extends APIResource {
   ...
   */
  createPrediction(
    params: RunCreatePredictionParams,
    options?: RequestOptions,
  ): APIPromise<RunCreatePredictionResponse> {
    const { webhook_url, ...body } = params;
    return this._client.post('/v1/run', { query: { webhook_url }, body, ...options });
  }
}

export interface RunCreatePredictionResponse {
  /**
...
export type RunCreatePredictionParams =
  | RunCreatePredictionParams.TryOnRequest
  | RunCreatePredictionParams.ModelCreateRequest
  | RunCreatePredictionParams.ModelVariationRequest
  | RunCreatePredictionParams.ModelSwapRequest
  | RunCreatePredictionParams.ReframeRequest
  | RunCreatePredictionParams.BackgroundChangeRequest
  | RunCreatePredictionParams.BackgroundRemoveRequest;

export declare namespace RunCreatePredictionParams {
