...
const EMBEDDED_METHODS: MethodEntry[] = [
  {
    ...
    params: [
      "body: { inputs: { garment_image: string; model_image: string; category?: 'auto' | 'tops' | 'bottoms' | 'one-pieces'; garment_photo_type?: 'auto' | 'flat-lay' | 'model'; mode?: 'performance' | 'balanced' | 'quality'; moderation_level?: 'conservative' | 'permissive' | 'none'; num_samples?: number; output_format?: 'png' | 'jpeg'; return_base64?: boolean; seed?: number; segmentation_free?: boolean; }; model_name: 'tryon-v1.6'; } | { inputs: { product_image: string; aspect_ratio?: '1:1' | '2:3' | '3:4' | '4:5' | '5:4' | '4:3' | '3:2' | '16:9' | '9:16'; image_prompt?: string; model_image?: string; output_format?: 'png' | 'jpeg'; prompt?: string; resolution?: '1k' | '4k'; return_base64?: boolean; seed?: number; }; model_name: 'product-to-model'; } | { inputs: { face_image: string; aspect_ratio?: '1:1' | '4:5' | '3:4' | '2:3' | '9:16'; output_format?: 'png' | 'jpeg'; prompt?: string; return_base64?: boolean; seed?: number; }; model_name: 'face-to-model'; } | { inputs: { prompt: string; aspect_ratio?: '1:1' | '2:3' | '3:4' | '4:5' | '5:4' | '4:3' | '3:2' | '16:9' | '9:16'; disable_prompt_enhancement?: boolean; image_reference?: string; lora_url?: string; output_format?: 'png' | 'jpeg'; reference_type?: 'pose' | 'silhouette'; return_base64?: boolean; seed?: number; }; model_name: 'model-create'; } | { inputs: { model_image: string; lora_url?: string; output_format?: 'png' | 'jpeg'; return_base64?: boolean; seed?: number; variation_strength?: 'subtle' | 'strong'; }; model_name: 'model-variation'; } | { inputs: { model_image: string; background_change?: boolean; disable_prompt_enhancement?: boolean; lora_url?: string; output_format?: 'png' | 'jpeg'; prompt?: string; return_base64?: boolean; seed?: number; }; model_name: 'model-swap'; } | { inputs: { aspect_ratio: '21:9' | '1:1' | '4:3' | '3:2' | '2:3' | '5:4' | '4:5' | '3:4' | '16:9' | '9:16'; image: string; num_images?: number; output_format?: 'png' | 'jpeg'; return_base64?: boolean; seed?: number; }; model_name: 'reframe'; } | { inputs: { image: string; prompt: string; disable_prompt_enhancement?: boolean; output_format?: 'png' | 'jpeg'; return_base64?: boolean; seed?: number; }; model_name: 'background-change'; } | { inputs: { image: string; return_base64?: boolean; }; model_name: 'background-remove'; } | { inputs: { image: string; duration?: 5 | 10; negative_prompt?: string; prompt?: string; resolution?: '480p' | '720p' | '1080p'; }; model_name: 'image-to-video'; } | { inputs: { image: string; prompt: string; image_context?: string; mask?: string; num_images?: number; output_format?: 'png' | 'jpeg'; resolution?: '1k' | '4k'; return_base64?: boolean; seed?: number; }; model_name: 'edit'; };",
      'webhook_url?: string;',
    ],
